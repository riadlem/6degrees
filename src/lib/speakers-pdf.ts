...
function makeHeader(eventName: string, subtitle: string, count: number, ownerName: string) {
  return createElement(
    ...
    createElement(Text, { style: headerStyles.title    }, eventName),
    createElement(Text, { style: headerStyles.subtitle }, subtitle),
    createElement(Text, { style: headerStyles.meta },
      `${count} speaker${count !== 1 ? "s" : ""} · Sorted by priority · ${ownerName} · ${new Date().toLocaleDateString("fr-FR")}`)
  )
}

function makeFooter() {
  return createElement(Text, { style: headerStyles.footer }, "Generated by 6Degrees · 6degrees.app")
}
      ...
      ...speakers.map((s, idx) => {
        ...
        return createElement(
          ...
          createElement(
            ...
            s.sessionTopic ? createElement(Text, { style: cardStyles.session }, s.sessionTopic) : null,
          )
        )
      }),
      makeFooter()
...
// ── LAYOUT: list (compact table, no photos) ───────────────────────────────────
...
const listStyles = StyleSheet.create({
  ...
  badge: {
    borderRadius: 4,
    paddingTop: 2, paddingBottom: 2, paddingLeft: 5, paddingRight: 5,
    width: 56, alignItems: "center", justifyContent: "center", marginRight: 10,
  },
  ...
  companyCol: { flex: 2, marginRight: 6 },
  company: { fontSize: 8, color: "#2563EB" },
  sessionCol: { flex: 3 },
  session: { fontSize: 7, color: "#92400E", backgroundColor: "#FFFBEB", borderRadius: 3,
    paddingTop: 1, paddingBottom: 1, paddingLeft: 4, paddingRight: 4, alignSelf: "flex-start" },
  headerRow: {
    flexDirection: "row", alignItems: "center",
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(View, { style: { width: 66, marginRight: 10 } },
        ...
        createElement(View, { style: listStyles.sessionCol },
          createElement(Text, { style: listStyles.headerText }, "Session")
        ),
      ),
      ...speakers.map((s, idx) => {
        const cfg = s.priority !== null ? PRIO_PDF[s.priority] : null
        ...
        return createElement(
          ...
          createElement(
            View, { style: Object.assign({}, listStyles.badge, { backgroundColor: cfg?.bg ?? "#F3F4F6", width: 66 }) },
            cfg
              ? createElement(View, { style: { flexDirection: "row", gap: 1 } },
                  ...makeDiamonds(s.priority!),
                )
              : null,
          ),
          ...
          createElement(
            View, { style: listStyles.sessionCol },
            s.sessionTopic
              ? createElement(Text, { style: listStyles.session }, s.sessionTopic)
              : null,
          ),
        )
      }),
...
const gridStyles = StyleSheet.create({
  ...
  session: { fontSize: 6, color: "#92400E", backgroundColor: "#FFFBEB",
    borderRadius: 2, paddingTop: 1, paddingBottom: 1, paddingLeft: 3, paddingRight: 3,
          ...
          return createElement(
            ...
            createElement(
              ...
              createElement(
                ...
                s.sessionTopic ? createElement(Text, { style: gridStyles.session }, s.sessionTopic) : null,
              ),
            )
          )
        })
...
export async function generateSpeakersPdf({
  ...
  const needsPhotos = layout === "cards" || layout === "grid"

  const photoDataUrls = needsPhotos
    ? await Promise.all(
  ...
  if (layout === "list") {
    doc = renderListLayout(speakers, eventName, subtitle, ownerName)
  } else if (layout === "grid") {
