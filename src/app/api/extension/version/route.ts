...
const VERSION_INFO = {
  ...
  notes: [
    ...
    "         news-post company links (ORAK, past employers) are no longer picked.",
    "         Fix French/localized logo alt: handle 'Logo de X' / 'Logo von X'",
    "         format (Strategies 2 & 4 now work on French LinkedIn).",
    "         Fix photo: add rendered display width to score — profile photo is",
    "         ~96px on screen, mutual-connection thumbnail ~32px; this reliably",
    "         wins when srcset is absent (score was 0 for both, DOM order wrong).",
